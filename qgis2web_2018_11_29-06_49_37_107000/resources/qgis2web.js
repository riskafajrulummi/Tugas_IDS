...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 28, minZoom: 4, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [110.210877, -8.027440, 448403.311800, 9141229.889100],
            units: 'degrees'})
    })
});
...
map.getView().fit([110.210877, -8.027440, 448403.311800, 9141229.889100], map.getSize());
